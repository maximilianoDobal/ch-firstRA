...
const ItemList = () => {
  ...
  // return <button onClick={createProductsOnFirestore}>Agrega productos wachin</button>
        ...
        <Row>
          ...
          {prods.map((prod) => {
            return (
              <Col
                md={4}
                className="d-flex flex-column align-items-center align-content-md-center justify-items-md-center"
              >
                <Item
                  key={prods.id}
                  id={prod.id}
